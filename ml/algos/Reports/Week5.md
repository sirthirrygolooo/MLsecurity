...
<body>
  ...
  <div class="section">
    ...
    <div class="section-content">
      ...
      <p><strong>Period:</strong> Week 5 - 05/05/2025 to 09/05/2025</p>
    </div>
  </div>
  <div class="section">
    ...
    <div class="section-content">
      <ul>
        <li><strong>Objective 1:</strong> Understand exactly how different adversarial attacks work  </li>
        <li><strong>Objective 2:</strong> Analyze pixel distributions of gradient-based attacks to search for patterns </li>
        <li><strong>Objective 3:</strong> Clearly classify different types of attack and their level of execution </li>
      </ul>
    </div>
  </div>
  <div class="section">
